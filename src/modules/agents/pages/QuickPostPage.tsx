...
const QuickPostPage: React.FC = () => {
    ...
    const canGoStep3 = !!selectedCategoryId && selectedServices.length > 0;
    const canGoStep4 =
        !!eta.trim() &&
        !!port.trim() &&
        !!ship.trim() &&
        ...
        const newJob = {
            ...
            title:
                listingType === 'agency-partnership'
                    ? `${selectedCategory?.title || 'Yeni İlan'} - İş Ortaklığı`
                    : selectedCategory?.title || 'Yeni İlan',
            shipName: ship,
            location: port,
                        ...
                        <div className="flex items-center gap-4">
                            {isEditMode && (
                                <button
                                    ...
                                    className="w-12 h-12 flex items-center justify-center rounded-xl bg-slate-100 text-slate-600 hover:bg-primary/10 hover:text-primary transition-all hover:scale-105"
                                >
            ...
            <div className="rounded-3xl border border-slate-200 bg-white shadow-sm">
                ...
                {step === 2 && (
                    <div className="p-6 md:p-8">
                        ...
                        <p className="mt-2 text-slate-500">
                            İlanınıza en uygun ana kategoriyi ve alt hizmetleri işaretleyin.
                        </p>
                                    ...
                                    <div className="mt-6 space-y-3">
                                        {selectedCategory.items.map((item) => {
                                            ...
                                            return (
                                                <label
                                                    key={item}
                                                    className={`flex cursor-pointer items-center gap-3 rounded-2xl border bg-white p-4 transition-all ${checked
                        ...
                        <div className="mt-8 grid gap-5 lg:grid-cols-[1.1fr_0.9fr]">
                            ...
                            <div className="rounded-3xl border border-slate-200 bg-white p-6">
                                ...
                                <div className="mt-5 space-y-4">
                                    ...
                                    <div className="rounded-2xl bg-slate-50 p-4">
                                        <p className="text-sm text-slate-500">Ana kategori</p>
                                        <p className="mt-1 font-semibold text-slate-800">
                                            {selectedCategory?.title || '-'}
                                        </p>
                                    </div>
