    ...
    <DashboardLayout role="agent">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-8">
        <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700/50">
          ...
          <p className="mt-3 text-sm text-blue-500 font-semibold">Bu hafta +6 yeni teklif</p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700/50">
          ...
          <p className="text-3xl font-extrabold text-slate-800 dark:text-white">8</p>
        ...
        <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700/50">
          ...
          <p className="text-3xl font-extrabold text-slate-800 dark:text-white">5</p>
        ...
        <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700/50">
          ...
          <p className="text-3xl font-extrabold text-slate-800 dark:text-white">₺93.000</p>
